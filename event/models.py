...
class EventSchema(Base):
    ...
    db_status = Column(Integer, nullable=False, default=schemas.SqlStructureDbStatus.EDIT_IN_PROGRESS)
    migrate_status = Column(Integer, nullable=False, default=schemas.DataDbMigrateStatus.DB_PENDING)
